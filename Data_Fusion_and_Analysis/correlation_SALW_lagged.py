...
ax.set_xticklabels(['No. of Incidents', 'No. of Deaths', 'Imports lag 1', 'Imports lag 2'], fontsize=12, rotation=360)
ax.set_yticklabels(['No. of Incidents', 'No. of Deaths', 'Imports lag 1', 'Imports lag 2'], fontsize=12, rotation=90)
plt.show()
