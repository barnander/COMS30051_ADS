...
data_for_test = merged_data.pivot(index='year', columns='country', values=['No_Incidents', 'total_arms_value_lag1']).dropna()
...
for country in data_for_test['No_Incidents'].columns:
    ...
    df_test = data_for_test[['No_Incidents', 'total_arms_value_lag1']][country]
